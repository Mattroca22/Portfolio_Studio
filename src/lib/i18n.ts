...
export const translations = {
  ES: {
    ...
    hero: {
      ...
      headline1: "Convierto tu caos digital",
      headline2: "en un negocio que crece solo.",
      subtitle: "Consultor Digital | Especialista en Datos | Soluciones con IA",
      description: "No necesitas entender tecnología. Solo necesitas resultados: más ventas, menos trabajo manual, y decisiones basadas en datos reales.",
      ctaProjects: "Ver resultados →",
      ctaCall: "Agendar llamada gratis",
    },
    stats: {
    ...
    results: {
      ...
      title: "Impacto medible en tu negocio",
      subtitle: "No prometo tecnología, prometo resultados que puedes ver en tu cuenta bancaria.",
  ...
  EN: {
    ...
    hero: {
      ...
      headline1: "I turn your digital chaos",
      headline2: "into a business that grows itself.",
      subtitle: "Digital Consultant | Data Specialist | AI Solutions",
      description: "You don't need to understand technology. You just need results: more sales, less manual work, and decisions based on real data.",
      ctaProjects: "See results →",
      ctaCall: "Schedule free call",
    },
    stats: {
    ...
    results: {
      label: "REAL RESULTS",
      title: "Measurable impact on your business",
      subtitle: "I don't promise technology, I promise results you can see in your bank account.",
